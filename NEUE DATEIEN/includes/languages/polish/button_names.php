...
define('BUTTON_ADD_PRODUCTS_TO_CART_ALT','wybrane produkty w koszyku');
...
define('BUTTON_DROPSHIPPING_ALT', 'Zamówienie specjalne');
define('BUTTON_DROPSHIPPING_SMALL_ALT', 'Zamówienie specjalne');
define('BUTTON_EDIT_SMALL_ALT', 'Edytuj');
define('BUTTON_IN_CART_ALT', 'Dodaj do koszyka');
define('BUTTON_LOGIN_ALT', 'Zaloguj się');
define('BUTTON_LOOKUP_ALT', 'Widok');
define('BUTTON_MY_ORDERS_TEXT', 'Moje zamówienia');
...
define('BUTTON_SUBMIT_ALT', 'Wysyłanie');
define('BUTTON_SUBMIT_GO_ALT', 'Wyślij');
...
define('BUTTON_VIEW_ALL_ALT', 'Pokaż wszystko');
define('BUTTON_ASK_A_QUESTION_ALT', 'Pytanie o artykuł');
