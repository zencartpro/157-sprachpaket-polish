...
define('MODULE_SHIPPING_STOREPICKUP_TEXT_TITLE', 'Odbiorę osobiście w sklepie');
define('MODULE_SHIPPING_STOREPICKUP_TEXT_DESCRIPTION', 'Klient odbierze towar osobiście ze sklepu');
define('MODULE_SHIPPING_STOREPICKUP_TEXT_WAY', 'Odbiór osobisty w sklepie');
