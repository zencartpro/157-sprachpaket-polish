...
define('EMAIL_TEXT_ORDER_CUSTOMER_GENDER_MALE', 'Szanowny Panie ');
define('EMAIL_TEXT_ORDER_CUSTOMER_GENDER_FEMALE', 'Szanowna Pani ');
define('EMAIL_TEXT_ORDER_CUSTOMER_NEUTRAL', 'Witam ');
define('EMAIL_TEXT_UPDATEINFO', 'Poinformujemy Cię o statusie Twojego zamówienia pod adresem ');
define('EMAIL_TEXT_ORDER_NUMBER', 'Numer zamówienia:');
define('EMAIL_TEXT_INVOICE_URL', 'Faktura szczegółowa:');
define('EMAIL_TEXT_DATE_ORDERED', 'Data zamówienia:');
define('EMAIL_TEXT_COMMENTS_UPDATE', '<strong>Uwaga:</strong> ' . "\n\n");
define('EMAIL_TEXT_STATUS_UPDATED', 'Status zamówienia został zaktualizowany.' . "\n\n");
define('EMAIL_TEXT_STATUS_LABEL', '<strong>Nowy status:</strong> %s' . "\n\n");
define('EMAIL_TEXT_STATUS_PLEASE_REPLY', 'W razie jakichkolwiek pytań prosimy o kontakt pod adresem e-mail <a href="mailto:' . STORE_OWNER_EMAIL_ADDRESS . '">' . STORE_OWNER_EMAIL_ADDRESS . '</a>.<br>' . "\n");
